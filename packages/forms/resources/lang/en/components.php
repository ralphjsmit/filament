...
return [
    ...
    'rich_editor' => [
        ...
        'tools' => [
            ...
            'table_column_add_before' => 'Add column before',
            'table_column_add_after' => 'Add column after',
            'table_column_delete' => 'Delete column',
            'table_row_add_before' => 'Add row before',
            'table_row_add_after' => 'Add row after',
            'table_row_delete' => 'Delete row',
            'table_cell_merge' => 'Merge cells',
            'table_cell_split' => 'Split cell',
            'table_header_toggle' => 'Toggle header row',
            'underline' => 'Underline',
            'undo' => 'Undo',
        ],
